 ...
 * ---------------------------------------------------------------------------------------
 *
 * Clase ReportePreguntasRedesSocialesActivity
 *
 * Representa el controlador de la vista activity_reporte_preguntas_redes_sociales.xml
 */
public class ReportePreguntasRedesSocialesActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.reporte_redes_sociales_toolbar);
        setSupportActionBar(toolbar);

        tituloReporte = findViewById(R.id.titulo_reporte_preguntas_redes_sociales);
        gifReporte = findViewById(R.id.gif_reporte_preguntas_redes_sociales);
        descripcionReporte = findViewById(R.id.descripcion_reporte_preguntas_redes_sociales);
    ...
    protected void onStart() {
        ...
        if (puntos == 3)
        {
            ...
            descripcionReporte.setText(R.string.descripcion_muy_bien_redes_sociales);
        }
        else if (puntos == 2)
        {
            tituloReporte.setText(R.string.titulo_vas_por_buen_camino);
            gifReporte.setImageResource(R.drawable.vas_por_buen_camino);
            descripcionReporte.setText(R.string.descripcion_vas_por_buen_camino_redes_sociales);
        }
        else if (puntos == 1 || puntos == 0)
        {
            ...
            descripcionReporte.setText(R.string.descripcion_sigue_esforzandote_redes_sociales);
        }
    ...
    public void seguirAprendiendo(View view) {
        ...
        Intent seguirAprendiendoIntent = new Intent(ReportePreguntasRedesSocialesActivity.this, RedesSocialesActivity.class);
    ...
    public void volverAInicio(View view) {
        ...
        Intent volverAInicioIntent = new Intent(ReportePreguntasRedesSocialesActivity.this, MainMenuActivity.class);
    ...
    private void showInternetConnectionMessage(boolean isConnected) {
        ...
        if (isConnected)
        {
            ...
            {
                buildDialogInternetRestablished(ReportePreguntasRedesSocialesActivity.this);
            }
        ...
        else
        {
            ...
            buildDialog(ReportePreguntasRedesSocialesActivity.this);
        }
    }
