 ...
 * ---------------------------------------------------------------------------------------
 *
 * Clase Pregunta3InternetActivity
 *
 * Representa el controlador de la vista activity_pregunta3_internet.xml
 */
public class Pregunta3InternetActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pregunta3_internet);
        Toolbar toolbar = findViewById(R.id.pregunta3_internet_toolbar);
        setSupportActionBar(toolbar);

        botonOpcion1 = findViewById(R.id.internet_pregunta_3_opcion_1);
        botonOpcion2 = findViewById(R.id.internet_pregunta_3_opcion_2);
        botonOpcion3 = findViewById(R.id.internet_pregunta_3_opcion_3);
        botonOpcion4 = findViewById(R.id.internet_pregunta_3_opcion_4);
        ...
        respuestaPregunta3 = findViewById(R.id.internet_pregunta_3_respuesta);
