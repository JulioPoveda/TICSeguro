...
public class HomeFragment extends Fragment {
    ...
    private void initImageBitmaps() {
        ...
        mImageUrls.add("android.resource://com.educationalappsdev.ticseguro/" + R.drawable.phishing);
        mNames.add("Phishing");

        mImageUrls.add("android.resource://com.educationalappsdev.ticseguro/" + R.drawable.redes_sociales);
        mNames.add("Redes Sociales");

        mImageUrls.add("android.resource://com.educationalappsdev.ticseguro/" + R.drawable.internet);
        mNames.add("Internet");

        mImageUrls.add("android.resource://com.educationalappsdev.ticseguro/" + R.drawable.contrasenas);
